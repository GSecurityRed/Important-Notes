...
- aws s3 são mt importantes, fazem parte de buckets de armazenamento. caso ache keys de s3 pode ser credenciais uteis para acessar esses bucktes atraves do awscli/aws configure.
